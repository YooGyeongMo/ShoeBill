namespace DBP_TeamProject.Forms
{
    partial class EmployeeRegistration : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            employeeAddPanel.Location = new Point(28, 17);
            employeeAddPanel.Margin = new Padding(4, 4, 4, 4);
            employeeAddPanel.Name = "employeeAddPanel";
            employeeAddPanel.Size = new Size(960, 617);
            ...
            // loadAddressButton
            // 
            loadAddressButton.Location = new Point(303, 81);
            ...
            label42.Location = new Point(27, 91);
            ...
            rateComboBox.Items.AddRange(new object[] { "일반 사원" });
